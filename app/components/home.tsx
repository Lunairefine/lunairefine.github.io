...
export default function Landing(): JSX.Element {
  ...
  <div className="w-[600px] h-[600px] bg-gradient-to-br from-purple-500 via-fuchsia-500 to-pink-500 opacity-30 blur-3xl rounded-full animate-aurora" style={{ top: '10%', left: '50%', transform: 'translateX(-50%)', position: 'absolute' }}></div>
</div>
